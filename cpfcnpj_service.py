...
# ⚡ Bolt: Use connection pooling to avoid repeated TLS handshakes during batch API queries
# Impact: Reduces latency by ~100-200ms per request for subsequent calls to the same host
