...
# ⚡ Bolt: Use a shared session to reuse TCP connections across API calls (connection pooling).
# This dramatically speeds up batch processing by avoiding the SSL handshake overhead on every request.
