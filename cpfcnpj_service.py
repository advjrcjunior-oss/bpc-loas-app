...
# Global session to enable HTTP connection pooling across multiple API calls,
# significantly improving performance during batch operations.
...
def consultar_cpf(cpf: str) -> dict:
    ...
    # ⚡ Bolt: Usando requests.Session() para reaproveitar conexoes TCP/TLS (connection pooling)
