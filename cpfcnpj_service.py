...
# ⚡ Bolt: Connection pooling for external API requests
# Utiliza Session para reaproveitar conexões TCP (keep-alive) e reduzir
# latência de handshakes SSL repetidos durante processamento em lote.
