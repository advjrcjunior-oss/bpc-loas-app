...
# Note: LRU caching is intentionally omitted here per architectural memory because
# downstream processes (like validar_dados_cliente) mutate the returned dictionary.
_cpfcnpj_session = requests.Session()
...
def consultar_cpf(cpf: str) -> dict:
    ...
    resp = _cpfcnpj_session.get(url, timeout=15)
