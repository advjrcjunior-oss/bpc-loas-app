...
# ⚡ Bolt: Use a global requests.Session to enable TCP connection pooling.
# This significantly speeds up multiple sequential API requests by reusing the underlying connection.
