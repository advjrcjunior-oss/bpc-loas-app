...
def organizar_pasta(pasta):
    ...
    ORDEM = [
        ...
        (5, "DOCUMENTO DO MENOR", ["DOC. DE IDENTIFICAÇÃO-CERTIDÃO DE NASCIMENTO.pdf",
                             "DOC. DE IDENTIFICAÇÃO-RG-AUTORA", "rg-autora", "rg.autora",
                             "ID HEITOR", "ID ESTHEFANY", "ID MAYCON", "ID ADRIAN", "ID LAURA",
        ...
        (6, "DOCUMENTO DO RESPONSAVEL", ["DOC. DE IDENTIFICAÇÃO-RG-REPRESENTANTE", "DOC. DE IDENTIFICAÇÃO-CNH-REPRESENTANTE",
                                   "rg.representante", "rg.mae", "rg.pai", "cnh-representante",
                                   "DOC. DE IDENTIFICAÇÃO-RG-PAI", "DOC. DE IDENTIFICAÇÃO-CNH-PAI",
                                   "ID JULIANA", "ID PATRICIA", "ID LARISSA", "ID JESSICA", "ID RESPONSAVEL",
        ...
        (9, "DOCUMENTOS DO GRUPO FAMILIAR", ["grupo_familiar", "DOC. DE IDENTIFICAÇÃO-CERTIDÃO DE NASCIMENTO-IRM",
                                       ...
                                       "rg.raissa", "cpf.raissa", "rg.irmao", "rg.irma",
        ...
        (15, "RECEITAS E EXAMES", ["receita", "receituario", "receituário", "exame", "encaminhamento", "ENCAMINHAMENTO",
                                   "COMPROVANTE DE AGENDAMENTO", "COMPROVANTE-LISTA", "GUIA",
                                   "15_receitas"]),
        (16, "COMPROVANTE DE GASTOS", ["fatura", "FATURA", "nota.fiscal", "comprovante.gasto",
                                       "COMPROVANTE DE GASTOS", "16_comprovante"]),
