...
# VIACEP SERVICE
# ============================================================
# ⚡ Bolt: Use a shared session to reuse TCP connections across ViaCEP API calls (connection pooling).
# Avoids using @functools.lru_cache here since caching a network failure state permanently breaks the batch pipeline.
