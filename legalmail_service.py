...
# VIACEP SERVICE
# ============================================================
# ⚡ Bolt Optimization: Connection Pooling for ViaCEP
# Using a shared requests.Session() to reuse TCP connections for ViaCEP queries,
# which are often called in a loop during batch processing.
